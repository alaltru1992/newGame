...
export default class Game {
    ...
    constructor(actor,boss1,boss2,boss3) {
        this.speed = {x:1, y:1};
        this.pos = {x: 0, y: 0};
        this.actor = actor;
    ...
    tick() {
        if((this.boss1.gameStop === 1)&&(this.boss2.gameStop === 1)&&(this.boss3.gameStop === 1)) {
            this.pos = {x: this.actor.pos.x, y: this.actor.pos.y}
        }
        else if((this.boss1.gameStop === 0)||(this.boss2.gameStop === 0)||(this.boss3.gameStop === 0)){
